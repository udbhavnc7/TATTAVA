...
**Tattva** (Ananta AI Workspace) is an intelligent, syllabus-grounded workspace engineered specifically for university engineering students preparing for rigorous semester exams (e.g., Computer Networks, Database Management Systems, Operating Systems, Data Structures).
...
1. **Clone the repository** (or extract project directory):
   ```bash
   git clone https://github.com/your-username/tattva-ai-workspace.git
